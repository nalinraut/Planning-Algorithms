...
def reset():
    global count
    screen.fill(white)#background color for the screen
    init_obstacles(GAME_LEVEL)#displays obstacles
    count = 0
...
def main():
    ...
    #initPoseSet = False
    #initialPoint = Node((0.0,0.0), None)
    #goalPoseSet = False
    #goalPoint = Node((630.0,470.0), None)
    currentState = 'init'
